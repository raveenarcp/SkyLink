...
public class HomePageController {
    ...
    {
        fxmlLoader = new FXMLLoader(Main.class.getResource("/skylink/pkg/HomePage/HomePage.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        stage.setTitle("SkyLink!");
    ...
    public void homePageOnSignUp(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HomePageController.class.getResource("/skylink/pkg/HomePage/HomePageSignUp.fxml"));
    ...
    public void homePageOnSignIn(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HomePageController.class.getResource("/skylink/pkg/HomePage/HomePageSignIn.fxml"));
