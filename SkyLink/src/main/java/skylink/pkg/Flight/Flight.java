...
public class Flight {
    ...
    private Deque<User> waitlist = new LinkedList<>();
    ...
    public static Array<Flight>flights = new Array<>();
    ...
    public void addToWaitlist(User user) {
        waitlist.addToBack(user); 
    }

    public User removeFromWaitlist() {
        return waitlist.removeFromFront(); 
    }

    public User peekWaitlist() {
        return waitlist.getFront(); 
    }
